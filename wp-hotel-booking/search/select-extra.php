...
<form class="hb-select-extra-results" name="hb-select-extra-results">
	<?php if ( $room_extra ) { ?>
                    ...
                    <div class="hb_package_title">
                        ...
                        <div class="hb_extra_detail_price">
                            ...
                            <label>
                                ...
                                <small><?php printf( '/ %s', $extra->respondent_name ? $extra->respondent_name : __( 'Package', 'rezoto' ) ) ?></small>
                            </label>
                        </div>
                    </div>
        ...
        <a href="javascript:history.go(-1)"
           class="hb_button hb_button_secondary"><?php _e( 'Back to search', 'rezoto' ); ?></a>

        <button type="submit" class="hb_button"><?php _e( 'Next step', 'rezoto' ); ?></button>
	<?php } else {
		_e( 'There is no extra option of this room', 'rezoto' );
	} ?>
</form>