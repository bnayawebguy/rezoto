...
<?php
	$room_layout = get_theme_mod( 'rezoto_rooms_page_layout', 'list' );
	...
	$excerpt_length = get_theme_mod( 'rezoto_room_excerpt_length', 100 );
	$view_more_txt = get_theme_mod( 'rezoto_room_viewmore_text', 'View More' );
	$show_desc_text = get_theme_mod( 'rezoto_enable_room_desc_text', 1 );
