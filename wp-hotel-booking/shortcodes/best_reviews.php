<?php
/**
 * The template for displaying shortcode best reviews.
 *
...
<div id="hotel_booking_best_reviews-<?php echo uniqid(); ?>" class="hotel_booking_best_reviews tp-hotel-booking rs-reviews-posts">
				...
				<li>
					...
					<div class="room-details">
						...
						<a href="<?php the_permalink(); ?>" class="book-now-btn">
							<?php esc_html_e( 'Book Now', 'rezoto' ); ?>
						</a>
					</div>
				</li>
			<?php endwhile; ?>
