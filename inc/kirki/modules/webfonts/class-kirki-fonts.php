...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'rezoto' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'rezoto' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'rezoto' ),
			'200'       => esc_html__( 'Light 200', 'rezoto' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'rezoto' ),
			'300'       => esc_html__( 'Book 300', 'rezoto' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'rezoto' ),
			'400'       => esc_html__( 'Normal 400', 'rezoto' ),
			'regular'   => esc_html__( 'Normal 400', 'rezoto' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'rezoto' ),
			'500'       => esc_html__( 'Medium 500', 'rezoto' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'rezoto' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'rezoto' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'rezoto' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'rezoto' ),
			'700'       => esc_html__( 'Bold 700', 'rezoto' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'rezoto' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'rezoto' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'rezoto' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'rezoto' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'rezoto' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'rezoto' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'rezoto' ),
		);
	}
