...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'rezoto' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'rezoto' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'rezoto' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'rezoto' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'rezoto' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'rezoto' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'rezoto' ); ?>',
} );
#>
