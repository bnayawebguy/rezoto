	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'rezoto' ),
				'remove'               => esc_html__( 'Remove', 'rezoto' ),
				'default'              => esc_html__( 'Default', 'rezoto' ),
				'selectFile'           => esc_html__( 'Select File', 'rezoto' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'rezoto' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'rezoto' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'rezoto' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'rezoto' ),
			)
		);
