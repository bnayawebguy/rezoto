...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'rezoto' ),
				'change'       => esc_html__( 'Change image', 'rezoto' ),
				'default'      => esc_html__( 'Default', 'rezoto' ),
				'remove'       => esc_html__( 'Remove', 'rezoto' ),
				'placeholder'  => esc_html__( 'No image selected', 'rezoto' ),
				'frame_title'  => esc_html__( 'Select image', 'rezoto' ),
				'frame_button' => esc_html__( 'Choose image', 'rezoto' ),
			)
		);
	}
